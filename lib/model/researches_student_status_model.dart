class ResearchesStudentStatusModel {
  List<ResearchesStatus>? researches;

  ResearchesStudentStatusModel({this.researches});

  ResearchesStudentStatusModel.fromJson(Map<String, dynamic> json) {
    if (json['researches'] != null) {
      researches = <ResearchesStatus>[];
      json['researches'].forEach((v) {
        researches!.add(new ResearchesStatus.fromJson(v));
      });
    }
  }
...
class ResearchesStatus {
  ...
  ResearchesStatus.fromJson(Map<String, dynamic> json) {
    sId = json['_id'];
