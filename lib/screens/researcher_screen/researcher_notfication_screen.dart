...
class ResearcherNotificationScreen extends StatefulWidget {
  const ResearcherNotificationScreen({Key? key}) : super(key: key);

  @override
  State<ResearcherNotificationScreen> createState() =>
      _ResearcherNotificationScreenState();
}

class _ResearcherNotificationScreenState
    extends State<ResearcherNotificationScreen> {
  @override
  void initState() {
